...
const Cards = () => {
  return (
    <div className="text-black w-full bg-white py-[10rem] px-4">
      <div className="max-w-{1240px] px-8 mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="w-full shadow-xl bg-gray-100 flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300">
          ...
          <button className="bg-black w-[150px] rounded-md font-medium my-6 mx-auto py-3 text-[#00df9a]">
            Start Trial
          </button>
        </div>
